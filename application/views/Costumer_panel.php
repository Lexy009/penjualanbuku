    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo site_url('Controller_Dashboard_Costumer') ?>">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Dashboard</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('Controller_buku_Costumer') ?>">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Buku</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('Controller_transaksi') ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" href="examples/profile.html">
                ...
                <span class="nav-link-text">Detail Transaksi</span>
              </a>
            </li>
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="Controller_login/logout" class="dropdown-item">
